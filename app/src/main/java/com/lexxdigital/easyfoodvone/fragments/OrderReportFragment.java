...
import com.lexxdigital.easyfoodvone.adapters.AdapterReportOrderList;
...
public class OrderReportFragment extends Fragment {
    ...
    private void clickListeners() {
        ...
        btnEndDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Constants.dateSelectorWithFormattedDate1(endDate, getActivity());
            }
        });
...
*/
    ...
    private void sentReport() {
        ...
        try {
            ...
            if (allRevenue)
            {
                apiRequest = apiService.getOrderReport(request);
            } else if (betweenDate) {
                apiRequest = apiService.getOrderReportBetweenDate(request);
            } else {
                apiRequest = apiService.getOrderReportByDate(request);
            }
