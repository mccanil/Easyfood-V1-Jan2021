                    ...
                    .subscribeWith(new DisposableSingleObserver<RevenueReportResponse>() {
                        ...
                        public void onSuccess(RevenueReportResponse data) {
                            ...
                            if (data.isSuccess()) {
                                ...
                                text_grossProfit.setText(data.getTotal_orders().getTotal_orders() == null || data.getTotal_orders().getTotal_orders().equalsIgnoreCase("") ? Constants.POUND + "0" : Constants.POUND + data.getTotal_orders().getTotal_orders());
