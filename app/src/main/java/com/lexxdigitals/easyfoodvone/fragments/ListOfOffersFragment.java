...
import com.lexxdigitals.easyfoodvone.adapters.AdapterOfferList;
import com.lexxdigitals.easyfoodvone.api_handler.ApiClient;
import com.lexxdigitals.easyfoodvone.api_handler.ApiInterface;
import com.lexxdigitals.easyfoodvone.create_combo_meals_offer.view.impl.CreateComboMealsOfferActivity;
import com.lexxdigitals.easyfoodvone.discount_offer_with_percentage.view.impl.DiscountOfferWithPercentageActivity;
import com.lexxdigitals.easyfoodvone.flat_discount_amount_offer.view.impl.FlatDiscountAmountOfferActivity;
...
import com.lexxdigitals.easyfoodvone.spend_x_get_x_discount.view.impl.SpendXgetXdiscountActivity;
...
public class ListOfOffersFragment extends Fragment implements AdapterOfferList.OnActionButtonClick {
    ...
    private void getOffers(String filter, String offerType) {
        ...
        try {
            ...
            disposable.add(apiService.getOffers(request)
    ...
    private void deleteOffers(String offerId, final int position) {
        try {
            ...
            ApiInterface apiService = ApiClient.getClient(getActivity()).create(ApiInterface.class);
            CompositeDisposable disposable = new CompositeDisposable();
            disposable.add(apiService.deleteOffer(request)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
