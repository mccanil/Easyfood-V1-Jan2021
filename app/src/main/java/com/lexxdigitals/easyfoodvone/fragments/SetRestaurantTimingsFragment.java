...
import com.lexxdigitals.easyfoodvone.adapters.AdapterRestaurantTimings;
import com.lexxdigitals.easyfoodvone.adapters.TimingAdapter;
import com.lexxdigitals.easyfoodvone.api_handler.ApiClient;
import com.lexxdigitals.easyfoodvone.api_handler.ApiInterface;
import com.lexxdigitals.easyfoodvone.dialogs.AddTimingDialog;
import com.lexxdigitals.easyfoodvone.dialogs.DeleteTimingDialog;
import com.lexxdigitals.easyfoodvone.dialogs.EditTimingDialog;
...
public class SetRestaurantTimingsFragment extends Fragment implements AdapterRestaurantTimings.OnAdapterItemClickListener,
    ...
    public void getRestaurantTiming(String restaurantId) {
        ...
        try {
            ...
            disposable.add(apiService.getRestaurantTiming(request)
    ...
    public void addTiming(String isOpen, String day, String openingTime, String deliveryTime, String collectionTiming) {
        ...
        try {
            ...
            ApiInterface apiService = ApiClient.getClient(getActivity()).create(ApiInterface.class);
            CompositeDisposable disposable = new CompositeDisposable();
            disposable.add(apiService.addNewTiming(request)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
    ...
    public void onUpdateButtonClicked(String id, String isOpen, String day, String openingTime, String deliveryTime, String collectionTiming) {
        ...
        try {
            ...
            ApiInterface apiService = ApiClient.getClient(getActivity()).create(ApiInterface.class);
            CompositeDisposable disposable = new CompositeDisposable();
            disposable.add(apiService.updateTiming(request)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribeWith(new DisposableSingleObserver<CommonResponse>() {
                        @Override
    ...
    public void onDeleteDilogOkClicked(final int position, String id) {
        ...
        try {
            ...
            ApiInterface apiService = ApiClient.getClient(getActivity()).create(ApiInterface.class);
            CompositeDisposable disposable = new CompositeDisposable();
            disposable.add(apiService.deleteTiming(request)
                    .subscribeOn(Schedulers.io())
                    .observeOn(AndroidSchedulers.mainThread())
                    .subscribeWith(new DisposableSingleObserver<CommonResponse>() {
                        @Override
