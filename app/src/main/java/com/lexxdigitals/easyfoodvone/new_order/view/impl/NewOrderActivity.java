...
import com.lexxdigitals.easyfoodvone.new_order.adapter.ProductListAdapter;
...
import com.lexxdigitals.easyfoodvone.new_order.models.datamodel.MealProduct;
import com.lexxdigitals.easyfoodvone.new_order.models.datamodel.Menu;
import com.lexxdigitals.easyfoodvone.new_order.models.datamodel.PreviousOrderDetailsModel;
import com.lexxdigitals.easyfoodvone.new_order.models.datamodel.ProductModifier;
import com.lexxdigitals.easyfoodvone.new_order.models.datamodel.SizeModifier;
...
public class NewOrderActivity extends AppCompatActivity implements Constants.DialogClickedListener {
    ...
    private void setMenuItems(NewDetailBean.OrdersDetailsBean.Cart data) {
        for (int i = 0; i < data.getMenu().size(); i++) {
            ...
            price.setText(getString(R.string.currency) +String.format("%.2f", data.getMenu().get(i).getPrice()));
                ...
                for (int j = 0; j < data.getMenu().get(i).getOptions().getMealProducts().size(); j++) {
                    ...
                    for (int k = 0; k < data.getMenu().get(i).getOptions().getMealProducts().get(j).getSizeModifiers().size(); k++) {
                        ...
                        for (int l = 0; l < data.getMenu().get(i).getOptions().getMealProducts().get(j).getSizeModifiers().get(k).getSizeModifierProducts().size(); l++) {
                            ...
                            priceModi.setText(getString(R.string.currency) + data.getMenu().get(i).getOptions().getMealProducts().get(j).getSizeModifiers().get(k).getSizeModifierProducts().get(l).getAmount());
            ...
            if (data.getMenu().get(i).getOptions().getSize() != null && data.getMenu().get(i).getOptions().getSize().getProductSizeName() != null) {
                ...
                priceSizeModi.setText(getString(R.string.currency) + data.getMenu().get(i).getOptions().getSize().getProductSizePrice());
