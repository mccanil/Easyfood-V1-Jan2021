package com.easyfoodvone.login.view.impl;
...
import com.easyfoodvone.contact_support.view.impl.ContactSupportActivity;
import com.easyfoodvone.forgot_password.view.impl.ForgotPasswordActivity;
import com.easyfoodvone.login.models.LoginRequest;
import com.easyfoodvone.login.models.LoginResponse;
import com.easyfoodvone.login.presenter.SigninPresenter;
import com.easyfoodvone.orders.view.impl.OrdersActivity;
import com.easyfoodvone.signup.RegisterActivity;
            ...
            disposable.add(apiService.login(request)
                    ...
                    .subscribeWith(new DisposableSingleObserver<LoginResponse>() {
                        ...
                        public void onSuccess(LoginResponse data) {
                            ...
                            if (data.isSuccess()) {
                                loginResponse = data;
                                PrefManager.getInstance(LoginActivity.this).savePreference(AUTH_TOKEN, data.getData().getToken());
