...
import com.easyfoodvone.databinding.LayoutCancelDialogBinding;
...
public class CharityFragment extends Fragment implements View.OnClickListener, PreviousMealListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void getCharityInfo() {
        if (isInternetOn(getActivity())) {
            ...
            Call<CharityInfoBean> call = apiInterface.getCharityDetail(prefManager.getPreference(AUTH_TOKEN,""),jsonObject);
